...
const navItems = [
  { label: "Accueil", icon: Home, href: "/client" },
  { label: "Prendre RDV", icon: Calendar, href: "/client/book" },
  { label: "Mes rendez-vous", icon: User, href: "/client/appointments" },
  { label: "Ma file d'attente", icon: Clock, href: "/client/queue" },
];
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-600 font-medium mt-0.5">Espace Client</p>
            </div>
          </div>
        </div>
